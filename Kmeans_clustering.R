...
data<-read.csv("C:/Users/Mayank/Desktop/mYank/Jigsaw/Analytics_DSS_Jigsaw/Data Science with R/T11.1/Codes/preclass/Topic 11.1 - Clustering/Topic 11.1 - Clustering/k means Clustering/cust.csv")
...
table(data$Channel)/440
table(data$Region)/440
...
library(NbClust)
nb <- NbClust(data = sample[,7:12],distance = "euclidean",min.nc = 2,max.nc = 15,method = "kmeans",index = "silhouette")
nb$All.index
nb$Best.nc
